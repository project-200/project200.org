  ...
  return (
    <section className="py-10 bg-white overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="py-16 px-8 bg-black overflow-hidden rounded-3xl">
          ...
          <div className="md:max-w-sm mx-auto mb-10">
            <div className="flex flex-wrap -m-2">
              <div className="w-full p-2">
                <p
                  className=" py-2 w-full text-base text-gray-300 text-center bg-black outline-none placeholder-gray-500 rounded-full"
